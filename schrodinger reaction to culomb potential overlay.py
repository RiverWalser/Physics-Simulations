...
dt = 0.1        # Time step
total_time = 200567  # Total simulation time
...
for t in np.arange(0, total_time, dt):
    ...
    # Plot the probability density and force as a 3D surface plot
    ax.clear()
    ax.plot_surface(X, Y, probability_density, cmap='viridis', edgecolor='none')
    ax.plot_surface(X, Y, Force, cmap='hot', edgecolor='none', alpha=0.5)
    ax.set_xlabel('x')
    ax.set_ylabel('y')
    ax.set_zlabel('Probability Density / Force')
